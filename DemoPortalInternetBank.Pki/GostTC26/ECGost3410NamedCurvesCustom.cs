...
{
    internal class ECGost3410NamedCurvesCustom
    {
        ...
        private ECGost3410NamedCurvesCustom()
        {
        }

        static ECGost3410NamedCurvesCustom()
        {
            objIds = new Dictionary<object, object>();
            ...
            parameters[RosstandartObjectIdentifiersCustom.id_tc26_gost_3410_12_256_paramSetB] = value;
            ...
            parameters[RosstandartObjectIdentifiersCustom.id_tc26_gost_3410_12_256_paramSetC] = value;
            ...
            parameters[RosstandartObjectIdentifiersCustom.id_tc26_gost_3410_12_256_paramSetD] = value;
            BigInteger q6 = new BigInteger("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFD97", 16);
            bigInteger = new BigInteger("400000000000000000000000000000000FD8CDDFC87B6635C115AF556C360C67", 16);
            fpCurve = new FpCurve(q6, new BigInteger("C2173F1513981673AF4892C23035A27CE25E2013BF95AA33B22C656F277E7335", 16), new BigInteger("295F9BAE7428ED9CCC20E7C359A9D41A22FCCD9108E17BF7BA9337A6F8AE9513", 16), bigInteger, BigInteger.One);
            ...
            objIds["Tc26-Gost-3410-12-256-paramSetB"] = RosstandartObjectIdentifiersCustom.id_tc26_gost_3410_12_256_paramSetB;
            objIds["Tc26-Gost-3410-12-256-paramSetC"] = RosstandartObjectIdentifiersCustom.id_tc26_gost_3410_12_256_paramSetC;
            objIds["Tc26-Gost-3410-12-256-paramSetD"] = RosstandartObjectIdentifiersCustom.id_tc26_gost_3410_12_256_paramSetD;
            ...
            names[RosstandartObjectIdentifiersCustom.id_tc26_gost_3410_12_256_paramSetB] = "Tc26-Gost-3410-12-256-paramSetB";
            names[RosstandartObjectIdentifiersCustom.id_tc26_gost_3410_12_256_paramSetC] = "Tc26-Gost-3410-12-256-paramSetC";
            names[RosstandartObjectIdentifiersCustom.id_tc26_gost_3410_12_256_paramSetD] = "Tc26-Gost-3410-12-256-paramSetD";
